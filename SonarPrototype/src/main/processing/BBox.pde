class BBox {
  ...
  void update(PVector pPos1, PVector pPos2) {
    pos1=pPos1;
  ...
  void update(PVector pPos, float pSize) {
    if (mode==CENTER) {
  ...
  boolean collisionTest(BBox pBBox) {
  ...
  boolean dCollision(float testX, float x1, float x2) {
